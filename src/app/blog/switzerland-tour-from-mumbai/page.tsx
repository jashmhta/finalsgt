...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Switzerland tour packages from Mumbai. Zurich, Lucerne, Interlaken, Jungfraujoch. Swiss rail pass included. From ₹89,999.",
    url: "https://www.shriganeshtravel.com/blog/switzerland-tour-from-mumbai",
    type: "article",
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <article className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Switzerland Tour from Mumbai — Alps, Lakes & Scenic Trains</h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-8 [&_h2]:mb-4 [&_h2]:text-white [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:mt-6 [&_h3]:mb-3 [&_h3]:text-gray-200 [&_p]:text-gray-300 [&_p]:mb-4 [&_p]:leading-relaxed [&_ul]:text-gray-300 [&_ul]:mb-4 [&_li]:mb-2 [&_strong]:text-white"
            dangerouslySetInnerHTML={{ __html: `<p>Looking for the best <strong>Switzerland tour from Mumbai</strong>? Shri Ganesh Travels offers all-inclusive packages with flights, hotels, meals, sightseeing, and transfers. With 37+ years of experience and 50,000+ happy families, we are Mumbai's most trusted tour operator.</p>
        ...
        <p>Since 1987, Shri Ganesh Travels has been Mumbai's go-to tour operator for <strong>Switzerland tour from Mumbai</strong>. We are powered by Mangirish Hospitality and have served over 50,000 families with our all-inclusive group and family tour packages.</p>
